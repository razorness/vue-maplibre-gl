 ...
 * - rerun dev server
 */
MglDefaults.style = import.meta.env.VITE_MAP_STYLE_KEY ? 'https://api.maptiler.com/maps/streets-v4/style.json?key=' + import.meta.env.VITE_MAP_STYLE_KEY : 'https://demotiles.maplibre.org/style.json';
	...
	setup() {
		...
		return {
			...
			mapStyles                  : [
				...
				{ name: 'Base', label: 'Basic', style: 'https://api.maptiler.com/maps/base-v4/style.json?key=?key=' + import.meta.env.VITE_MAP_STYLE_KEY },
				{ name: 'Bright', label: 'Bright', style: 'https://api.maptiler.com/maps/bright-v2/style.json?key=' + import.meta.env.VITE_MAP_STYLE_KEY },
				{
					name: 'Satellite', label: 'Satellite', style: 'https://api.maptiler.com/maps/hybrid-v4/style.json?key=' + import.meta.env.VITE_MAP_STYLE_KEY
				},
				{ name: 'Toner', label: 'Voyager', style: 'https://api.maptiler.com/maps/toner-v2/style.json?key=' + import.meta.env.VITE_MAP_STYLE_KEY }
			] as StyleSwitchItem[],
